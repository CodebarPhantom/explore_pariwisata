                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="content-block aligncenter">
                                                    ...
                                                    @endphp
                                                    <img src="{!! $base64 !!}" style="width:100%; max-width:150px; margin-top:25px"/>
                                                    <h2>{{ $receipt->tourism_name }}</h2>                                                    
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="alignright">
                                                                {{  $receipt->updated_at->translatedFormat("d F \'y") }}                                                               
                                                            </td>
                                                            <td>
                                                                ...
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr class="total">
                                                                            ...
                                                                            <td class="alignright">{{ number_format($receipt->grand_total) }}</td>
                                                                        </tr>
                                                                </tbody>
                                                            </table>
                                                            </td>
